...
public class ReturnedState implements MultimediumState {
    ...
    @Override
    public MultimediumState borrowMedium(String firstName, String lastName) {
    ...
    @Override
    public MultimediumState returnMedium() {
